...
const lastAttemptDetailPropsPath = path.resolve(
  process.cwd(),
  "components/media-asset-card-last-attempt-detail-props.ts",
);
const lastAttemptDetailPropsSource = fs.readFileSync(lastAttemptDetailPropsPath, "utf8");
const lastAttemptDetailPropsLineCount = lastAttemptDetailPropsSource.split(/\r?\n/).length;
const lastAttemptDetailPropsTypesPath = path.resolve(
  process.cwd(),
  "components/media-asset-card-last-attempt-detail-props.types.ts",
);
const lastAttemptDetailPropsTypesSource = fs.readFileSync(lastAttemptDetailPropsTypesPath, "utf8");
const lastAttemptDetailPropsTypesLineCount =
  lastAttemptDetailPropsTypesSource.split(/\r?\n/).length;
...
const nextRetryDetailPropsPath = path.resolve(
  process.cwd(),
  "components/media-asset-card-next-retry-detail-props.ts",
);
const nextRetryDetailPropsSource = fs.readFileSync(nextRetryDetailPropsPath, "utf8");
const nextRetryDetailPropsLineCount = nextRetryDetailPropsSource.split(/\r?\n/).length;
const nextRetryDetailPropsTypesPath = path.resolve(
  process.cwd(),
  "components/media-asset-card-next-retry-detail-props.types.ts",
);
const nextRetryDetailPropsTypesSource = fs.readFileSync(nextRetryDetailPropsTypesPath, "utf8");
const nextRetryDetailPropsTypesLineCount =
  nextRetryDetailPropsTypesSource.split(/\r?\n/).length;
...
const remoteFetchTagPropsPath = path.resolve(
  process.cwd(),
  "components/media-asset-card-remote-fetch-tag-props.ts",
);
const remoteFetchTagPropsSource = fs.readFileSync(remoteFetchTagPropsPath, "utf8");
const remoteFetchTagPropsLineCount = remoteFetchTagPropsSource.split(/\r?\n/).length;
const remoteFetchTagPropsTypesPath = path.resolve(
  process.cwd(),
  "components/media-asset-card-remote-fetch-tag-props.types.ts",
);
const remoteFetchTagPropsTypesSource = fs.readFileSync(remoteFetchTagPropsTypesPath, "utf8");
const remoteFetchTagPropsTypesLineCount = remoteFetchTagPropsTypesSource.split(/\r?\n/).length;
...
const retryStateTagPropsPath = path.resolve(
  process.cwd(),
  "components/media-asset-card-retry-state-tag-props.ts",
);
const retryStateTagPropsSource = fs.readFileSync(retryStateTagPropsPath, "utf8");
const retryStateTagPropsLineCount = retryStateTagPropsSource.split(/\r?\n/).length;
const retryStateTagPropsTypesPath = path.resolve(
  process.cwd(),
  "components/media-asset-card-retry-state-tag-props.types.ts",
);
const retryStateTagPropsTypesSource = fs.readFileSync(retryStateTagPropsTypesPath, "utf8");
const retryStateTagPropsTypesLineCount = retryStateTagPropsTypesSource.split(/\r?\n/).length;
...
const retryCountTagPropsPath = path.resolve(
  process.cwd(),
  "components/media-asset-card-retry-count-tag-props.ts",
);
const retryCountTagPropsSource = fs.readFileSync(retryCountTagPropsPath, "utf8");
const retryCountTagPropsLineCount = retryCountTagPropsSource.split(/\r?\n/).length;
const retryCountTagPropsTypesPath = path.resolve(
  process.cwd(),
  "components/media-asset-card-retry-count-tag-props.types.ts",
);
const retryCountTagPropsTypesSource = fs.readFileSync(retryCountTagPropsTypesPath, "utf8");
const retryCountTagPropsTypesLineCount = retryCountTagPropsTypesSource.split(/\r?\n/).length;
...
const fileExtensionTagPropsPath = path.resolve(
  process.cwd(),
  "components/media-asset-card-file-extension-tag-props.ts",
);
const fileExtensionTagPropsSource = fs.readFileSync(fileExtensionTagPropsPath, "utf8");
const fileExtensionTagPropsLineCount = fileExtensionTagPropsSource.split(/\r?\n/).length;
const fileExtensionTagPropsTypesPath = path.resolve(
  process.cwd(),
  "components/media-asset-card-file-extension-tag-props.types.ts",
);
const fileExtensionTagPropsTypesSource = fs.readFileSync(fileExtensionTagPropsTypesPath, "utf8");
const fileExtensionTagPropsTypesLineCount =
  fileExtensionTagPropsTypesSource.split(/\r?\n/).length;
...
const sizeTagPropsPath = path.resolve(process.cwd(), "components/media-asset-card-size-tag-props.ts");
const sizeTagPropsSource = fs.readFileSync(sizeTagPropsPath, "utf8");
const sizeTagPropsLineCount = sizeTagPropsSource.split(/\r?\n/).length;
const sizeTagPropsTypesPath = path.resolve(process.cwd(), "components/media-asset-card-size-tag-props.types.ts");
const sizeTagPropsTypesSource = fs.readFileSync(sizeTagPropsTypesPath, "utf8");
const sizeTagPropsTypesLineCount = sizeTagPropsTypesSource.split(/\r?\n/).length;
...
const processingStatusTagPropsPath = path.resolve(
  process.cwd(),
  "components/media-asset-card-processing-status-tag-props.ts",
);
const processingStatusTagPropsSource = fs.readFileSync(processingStatusTagPropsPath, "utf8");
const processingStatusTagPropsLineCount = processingStatusTagPropsSource.split(/\r?\n/).length;
const processingStatusTagPropsTypesPath = path.resolve(
  process.cwd(),
  "components/media-asset-card-processing-status-tag-props.types.ts",
);
const processingStatusTagPropsTypesSource = fs.readFileSync(processingStatusTagPropsTypesPath, "utf8");
const processingStatusTagPropsTypesLineCount =
  processingStatusTagPropsTypesSource.split(/\r?\n/).length;
...
const storageProviderTagPropsPath = path.resolve(
  process.cwd(),
  "components/media-asset-card-storage-provider-tag-props.ts",
);
const storageProviderTagPropsSource = fs.readFileSync(storageProviderTagPropsPath, "utf8");
const storageProviderTagPropsLineCount = storageProviderTagPropsSource.split(/\r?\n/).length;
const storageProviderTagPropsTypesPath = path.resolve(
  process.cwd(),
  "components/media-asset-card-storage-provider-tag-props.types.ts",
);
const storageProviderTagPropsTypesSource = fs.readFileSync(storageProviderTagPropsTypesPath, "utf8");
const storageProviderTagPropsTypesLineCount =
  storageProviderTagPropsTypesSource.split(/\r?\n/).length;
...
for (const requiredMetadataTagsUsage of [
  ...
  'import type { MediaAssetCardMetadataTagsProps } from "./media-asset-card-metadata-tags.types";',
  "export function MediaAssetCardMetadataTags(props: MediaAssetCardMetadataTagsProps) {",
  "readMediaAssetCardMetadataTagValues({ asset: props.asset })",
  "builderProps = { ...props, locale, ...readMediaAssetCardMetadataTagValues({ asset: props.asset }) }",
  "buildMediaAssetCardExtractionModeTagProps(builderProps)",
  "buildMediaAssetCardFileExtensionTagProps(builderProps)",
  "buildMediaAssetCardProcessingSourceTagProps(builderProps)",
  "buildMediaAssetCardRemoteFetchTagProps(builderProps)",
  "buildMediaAssetCardRetryCountTagProps(builderProps)",
  "buildMediaAssetCardRetryStateTagProps(builderProps)",
  "buildMediaAssetCardProcessingStatusTagProps(builderProps)",
  "buildMediaAssetCardSizeTagProps(builderProps)",
  "buildMediaAssetCardStorageProviderTagProps(builderProps)",
...
for (const forbiddenFileExtensionTagPropsToken of [
  "<MediaAssetCardFileExtensionTag",
  "metadata_json.file_extension",
  '<div className="tag-row">',
]) {
  if (fileExtensionTagPropsSource.includes(forbiddenFileExtensionTagPropsToken)) {
    throw new Error(`media-asset-card-file-extension-tag-props.ts must keep rendering and read rules delegated: ${forbiddenFileExtensionTagPropsToken}`);
  }
}

if (fileExtensionTagPropsLineCount > 5) {
  throw new Error(`media-asset-card-file-extension-tag-props.ts exceeded 5 lines: ${fileExtensionTagPropsLineCount}`);
}

for (const requiredFileExtensionTagPropsTypesUsage of [
  'import type { MediaAssetCardMetadataTagsProps } from "./media-asset-card-metadata-tags.types"; export type BuildMediaAssetCardFileExtensionTagPropsInput = Pick<MediaAssetCardMetadataTagsProps, "asset">;',
]) {
  if (!fileExtensionTagPropsTypesSource.includes(requiredFileExtensionTagPropsTypesUsage)) {
    throw new Error(`media-asset-card-file-extension-tag-props.types.ts must own file-extension-tag-props input typing: ${requiredFileExtensionTagPropsTypesUsage}`);
  }
}

if (fileExtensionTagPropsTypesLineCount > 2) {
  throw new Error(`media-asset-card-file-extension-tag-props.types.ts exceeded 2 lines: ${fileExtensionTagPropsTypesLineCount}`);
}
...
for (const requiredLastAttemptDetailPropsUsage of [
  ...
  if (!lastAttemptDetailPropsSource.includes(requiredLastAttemptDetailPropsUsage)) {
    throw new Error(`media-asset-card-last-attempt-detail-props.ts must own last-attempt detail prop projection: ${requiredLastAttemptDetailPropsUsage}`);
  }
}

for (const forbiddenLastAttemptDetailPropsToken of [
  "<MediaAssetCardLastAttemptDetail",
  "nextRetryAt",
  "asset,",
]) {
  if (lastAttemptDetailPropsSource.includes(forbiddenLastAttemptDetailPropsToken)) {
    throw new Error(`media-asset-card-last-attempt-detail-props.ts must keep rendering and unrelated detail concerns delegated: ${forbiddenLastAttemptDetailPropsToken}`);
  }
}

if (lastAttemptDetailPropsLineCount > 5) {
  throw new Error(`media-asset-card-last-attempt-detail-props.ts exceeded 5 lines: ${lastAttemptDetailPropsLineCount}`);
}

for (const requiredLastAttemptDetailPropsTypesUsage of [
  ...
  if (!lastAttemptDetailPropsTypesSource.includes(requiredLastAttemptDetailPropsTypesUsage)) {
    throw new Error(`media-asset-card-last-attempt-detail-props.types.ts must own last-attempt detail props input typing: ${requiredLastAttemptDetailPropsTypesUsage}`);
  }
}

if (lastAttemptDetailPropsTypesLineCount > 2) {
  throw new Error(`media-asset-card-last-attempt-detail-props.types.ts exceeded 2 lines: ${lastAttemptDetailPropsTypesLineCount}`);
}
...
for (const requiredNextRetryDetailPropsUsage of [
  ...
  if (!nextRetryDetailPropsSource.includes(requiredNextRetryDetailPropsUsage)) {
    throw new Error(`media-asset-card-next-retry-detail-props.ts must own next-retry detail prop projection: ${requiredNextRetryDetailPropsUsage}`);
  }
}

for (const forbiddenNextRetryDetailPropsToken of [
  "<MediaAssetCardNextRetryDetail",
  "lastAttemptAt",
  "asset,",
]) {
  if (nextRetryDetailPropsSource.includes(forbiddenNextRetryDetailPropsToken)) {
    throw new Error(`media-asset-card-next-retry-detail-props.ts must keep rendering and unrelated detail concerns delegated: ${forbiddenNextRetryDetailPropsToken}`);
  }
}

if (nextRetryDetailPropsLineCount > 5) {
  throw new Error(`media-asset-card-next-retry-detail-props.ts exceeded 5 lines: ${nextRetryDetailPropsLineCount}`);
}

for (const requiredNextRetryDetailPropsTypesUsage of [
  ...
  if (!nextRetryDetailPropsTypesSource.includes(requiredNextRetryDetailPropsTypesUsage)) {
    throw new Error(`media-asset-card-next-retry-detail-props.types.ts must own next-retry detail props input typing: ${requiredNextRetryDetailPropsTypesUsage}`);
  }
}

if (nextRetryDetailPropsTypesLineCount > 2) {
  throw new Error(`media-asset-card-next-retry-detail-props.types.ts exceeded 2 lines: ${nextRetryDetailPropsTypesLineCount}`);
}
...
for (const forbiddenRemoteFetchTagPropsToken of [
  "<MediaAssetCardRemoteFetchTag",
  "getRemoteFetchStatusLabel(",
  '<div className="tag-row">',
]) {
  if (remoteFetchTagPropsSource.includes(forbiddenRemoteFetchTagPropsToken)) {
    throw new Error(`media-asset-card-remote-fetch-tag-props.ts must keep rendering and label rules delegated: ${forbiddenRemoteFetchTagPropsToken}`);
  }
}

if (remoteFetchTagPropsLineCount > 5) {
  throw new Error(`media-asset-card-remote-fetch-tag-props.ts exceeded 5 lines: ${remoteFetchTagPropsLineCount}`);
}

for (const requiredRemoteFetchTagPropsTypesUsage of [
  ...
  if (!remoteFetchTagPropsTypesSource.includes(requiredRemoteFetchTagPropsTypesUsage)) {
    throw new Error(`media-asset-card-remote-fetch-tag-props.types.ts must own remote-fetch-tag-props input typing: ${requiredRemoteFetchTagPropsTypesUsage}`);
  }
}

if (remoteFetchTagPropsTypesLineCount > 2) {
  throw new Error(`media-asset-card-remote-fetch-tag-props.types.ts exceeded 2 lines: ${remoteFetchTagPropsTypesLineCount}`);
}
...
for (const forbiddenRetryStateTagPropsToken of [
  "<MediaAssetCardRetryStateTag",
  "getRetryStateLabel(",
  '<div className="tag-row">',
]) {
  if (retryStateTagPropsSource.includes(forbiddenRetryStateTagPropsToken)) {
    throw new Error(`media-asset-card-retry-state-tag-props.ts must keep rendering and label rules delegated: ${forbiddenRetryStateTagPropsToken}`);
  }
}

if (retryStateTagPropsLineCount > 5) {
  throw new Error(`media-asset-card-retry-state-tag-props.ts exceeded 5 lines: ${retryStateTagPropsLineCount}`);
}

for (const requiredRetryStateTagPropsTypesUsage of [
  ...
  if (!retryStateTagPropsTypesSource.includes(requiredRetryStateTagPropsTypesUsage)) {
    throw new Error(`media-asset-card-retry-state-tag-props.types.ts must own retry-state-tag-props input typing: ${requiredRetryStateTagPropsTypesUsage}`);
  }
}

if (retryStateTagPropsTypesLineCount > 2) {
  throw new Error(`media-asset-card-retry-state-tag-props.types.ts exceeded 2 lines: ${retryStateTagPropsTypesLineCount}`);
}
...
for (const forbiddenRetryCountTagPropsToken of [
  "<MediaAssetCardRetryCountTag",
  "{mediaIssueCopy.retries}",
  '<div className="tag-row">',
]) {
  if (retryCountTagPropsSource.includes(forbiddenRetryCountTagPropsToken)) {
    throw new Error(`media-asset-card-retry-count-tag-props.ts must keep rendering and retry-count rules delegated: ${forbiddenRetryCountTagPropsToken}`);
  }
}

if (retryCountTagPropsLineCount > 5) {
  throw new Error(`media-asset-card-retry-count-tag-props.ts exceeded 5 lines: ${retryCountTagPropsLineCount}`);
}

for (const requiredRetryCountTagPropsTypesUsage of [
  ...
  if (!retryCountTagPropsTypesSource.includes(requiredRetryCountTagPropsTypesUsage)) {
    throw new Error(`media-asset-card-retry-count-tag-props.types.ts must own retry-count-tag-props input typing: ${requiredRetryCountTagPropsTypesUsage}`);
  }
}

if (retryCountTagPropsTypesLineCount > 2) {
  throw new Error(`media-asset-card-retry-count-tag-props.types.ts exceeded 2 lines: ${retryCountTagPropsTypesLineCount}`);
}
...
for (const forbiddenProcessingStatusTagPropsToken of [
  "<MediaAssetCardProcessingStatusTag",
  "getProcessingStatusLabel(",
  '<div className="tag-row">',
]) {
  if (processingStatusTagPropsSource.includes(forbiddenProcessingStatusTagPropsToken)) {
    throw new Error(`media-asset-card-processing-status-tag-props.ts must keep rendering and label rules delegated: ${forbiddenProcessingStatusTagPropsToken}`);
  }
}

if (processingStatusTagPropsLineCount > 5) {
  throw new Error(`media-asset-card-processing-status-tag-props.ts exceeded 5 lines: ${processingStatusTagPropsLineCount}`);
}

for (const requiredProcessingStatusTagPropsTypesUsage of [
  'import type { MediaAssetCardMetadataTagsProps } from "./media-asset-card-metadata-tags.types"; import type { LocaleCode } from "../lib/locale"; export type BuildMediaAssetCardProcessingStatusTagPropsInput = Pick<MediaAssetCardMetadataTagsProps, "asset"> & { locale: LocaleCode };',
]) {
  if (!processingStatusTagPropsTypesSource.includes(requiredProcessingStatusTagPropsTypesUsage)) {
    throw new Error(`media-asset-card-processing-status-tag-props.types.ts must own processing-status-tag-props input typing: ${requiredProcessingStatusTagPropsTypesUsage}`);
  }
}

if (processingStatusTagPropsTypesLineCount > 2) {
  throw new Error(`media-asset-card-processing-status-tag-props.types.ts exceeded 2 lines: ${processingStatusTagPropsTypesLineCount}`);
}
...
for (const forbiddenSizeTagPropsToken of [
  "<MediaAssetCardSizeTag",
  "formatMediaSize(",
  '<div className="tag-row">',
]) {
  if (sizeTagPropsSource.includes(forbiddenSizeTagPropsToken)) {
    throw new Error(`media-asset-card-size-tag-props.ts must keep rendering and format rules delegated: ${forbiddenSizeTagPropsToken}`);
  }
}

if (sizeTagPropsLineCount > 5) {
  throw new Error(`media-asset-card-size-tag-props.ts exceeded 5 lines: ${sizeTagPropsLineCount}`);
}

for (const requiredSizeTagPropsTypesUsage of [
  ...
  if (!sizeTagPropsTypesSource.includes(requiredSizeTagPropsTypesUsage)) {
    throw new Error(`media-asset-card-size-tag-props.types.ts must own size-tag-props input typing: ${requiredSizeTagPropsTypesUsage}`);
  }
}

if (sizeTagPropsTypesLineCount > 2) {
  throw new Error(`media-asset-card-size-tag-props.types.ts exceeded 2 lines: ${sizeTagPropsTypesLineCount}`);
}
...
for (const forbiddenStorageProviderTagPropsToken of [
  "<MediaAssetCardStorageProviderTag",
  "getStorageProviderLabel(",
  '<div className="tag-row">',
]) {
  if (storageProviderTagPropsSource.includes(forbiddenStorageProviderTagPropsToken)) {
    throw new Error(`media-asset-card-storage-provider-tag-props.ts must keep rendering and label rules delegated: ${forbiddenStorageProviderTagPropsToken}`);
  }
}

if (storageProviderTagPropsLineCount > 5) {
  throw new Error(`media-asset-card-storage-provider-tag-props.ts exceeded 5 lines: ${storageProviderTagPropsLineCount}`);
}

for (const requiredStorageProviderTagPropsTypesUsage of [
  'import type { MediaAssetCardMetadataTagsProps } from "./media-asset-card-metadata-tags.types"; import type { LocaleCode } from "../lib/locale"; export type BuildMediaAssetCardStorageProviderTagPropsInput = Pick<MediaAssetCardMetadataTagsProps, "asset"> & { locale: LocaleCode };',
]) {
  if (!storageProviderTagPropsTypesSource.includes(requiredStorageProviderTagPropsTypesUsage)) {
    throw new Error(`media-asset-card-storage-provider-tag-props.types.ts must own storage-provider-tag-props input typing: ${requiredStorageProviderTagPropsTypesUsage}`);
  }
}

if (storageProviderTagPropsTypesLineCount > 2) {
  throw new Error(`media-asset-card-storage-provider-tag-props.types.ts exceeded 2 lines: ${storageProviderTagPropsTypesLineCount}`);
}
