...
if (workspaceExportJobsHeaderSource.includes("type WorkspaceExportJobsHeaderProps = {")) {
  throw new Error("workspace-export-jobs-header.tsx must keep export-jobs header prop typing delegated");
}

const maxWorkspaceExportJobsHeaderLines = 35;
...
if (workspaceExportJobsListItemSource.includes("type WorkspaceExportJobsListItemProps = Pick<")) {
  throw new Error("workspace-export-jobs-list-item.tsx must keep list-item prop typing delegated");
}

const maxWorkspaceExportJobsListItemLines = 35;
...
const maxWorkspaceMediaRetentionActionsLines = 70;
