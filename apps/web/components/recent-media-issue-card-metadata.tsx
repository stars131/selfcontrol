...
export function RecentMediaIssueCardMetadata({ action, formatHistoryTimestampLabel, issue, mediaIssueCopy }: RecentMediaIssueCardMetadataProps) {
  return <><RecentMediaIssueCardMetadataDetails formatHistoryTimestampLabel={formatHistoryTimestampLabel} issue={issue} mediaIssueCopy={mediaIssueCopy} /><RecentMediaIssueCardActionNotice {...buildRecentMediaIssueCardActionNoticeProps({ action })} /></>;
}
