...
import { createEmptyForm, type LocationReviewFormState, type RecordFormState, type ReminderFormState } from "../lib/record-panel-forms";
...
export function createRecordPanelControllerRecordHandlers({
  ...
  setSavingReminder: Dispatch<SetStateAction<boolean>>;
}) {
