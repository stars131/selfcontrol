...
export function buildRecentMediaIssueCardMetadataDetailsProps(input: BuildRecentMediaIssueCardMetadataDetailsPropsInput): RecentMediaIssueCardMetadataDetailsProps { return input; }
