...
type WorkspaceMediaRetentionCopyMap = Record<LocaleCode, WorkspaceMediaRetentionCopy>;

const COPY: WorkspaceMediaRetentionCopyMap = {
  "zh-CN": {
    eyebrow: "媒体保留",
    title: "媒体保留报告",
...
export function getWorkspaceMediaRetentionCopy(locale: LocaleCode): WorkspaceMediaRetentionCopy {
  return COPY[locale];
}
