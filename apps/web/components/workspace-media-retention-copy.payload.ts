import type { WorkspaceMediaRetentionCopyMap } from "./workspace-media-retention-copy.types";

export const WORKSPACE_MEDIA_RETENTION_COPY: WorkspaceMediaRetentionCopyMap = {
  "zh-CN": {
    eyebrow: "媒体保留",
    title: "媒体保留报告",
