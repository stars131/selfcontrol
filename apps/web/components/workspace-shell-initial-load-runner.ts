...
export async function runWorkspaceShellInitialLoad(activeToken: string, props: WorkspaceShellInitialLoadProps) {
  ...
  try {
    ...
    clearStoredSession();
    props.setError(resolveErrorMessage(caught, copy.loadWorkspaceDataFailed));
