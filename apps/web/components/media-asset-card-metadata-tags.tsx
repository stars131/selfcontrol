...
import { buildMediaAssetCardFileExtensionTagProps } from "./media-asset-card-file-extension-tag-props"; import { buildMediaAssetCardStorageProviderTagProps } from "./media-asset-card-storage-provider-tag-props";
...
export function MediaAssetCardMetadataTags({ asset, mediaIssueCopy }: MediaAssetCardMetadataTagsProps) {
  ...
  return <div className="tag-row"><MediaAssetCardProcessingStatusTag {...buildMediaAssetCardProcessingStatusTagProps({ asset, locale })} /><MediaAssetCardStorageProviderTag {...buildMediaAssetCardStorageProviderTagProps({ asset, locale })} /><MediaAssetCardSizeTag {...buildMediaAssetCardSizeTagProps({ asset })} /><MediaAssetCardProcessingSourceTag processingSource={processingSource} /><MediaAssetCardExtractionModeTag extractionMode={extractionMode} /><MediaAssetCardRemoteFetchTag locale={locale} mediaIssueCopy={mediaIssueCopy} remoteFetchStatus={remoteFetchStatus} /><MediaAssetCardRetryStateTag locale={locale} mediaIssueCopy={mediaIssueCopy} retryState={retryState} /><MediaAssetCardRetryCountTag mediaIssueCopy={mediaIssueCopy} retryCount={retryCount} retryMaxAttempts={retryMaxAttempts} /><MediaAssetCardFileExtensionTag {...buildMediaAssetCardFileExtensionTagProps({ asset })} /></div>;
}
