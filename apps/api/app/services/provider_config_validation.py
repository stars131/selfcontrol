...
def resolve_secret_env_name(*, provider_code: str, api_key_env_name: str | None) -> str | None:
    return normalize_api_key_env_name(api_key_env_name) or default_secret_env_name(provider_code)
...
def resolve_secret_status(*, provider_code: str, api_key_env_name: str | None) -> tuple[str, str | None]:
    env_name = resolve_secret_env_name(provider_code=provider_code, api_key_env_name=api_key_env_name)
    if not provider_requires_secret(provider_code):
