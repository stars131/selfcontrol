...
def test_isoformat_optional_datetime_normalizes_none_naive_and_aware_values() -> None:
    ...
    offset_aware = datetime.fromisoformat("2026-03-29T18:15:30+08:00")
    ...
    assert isoformat_optional_datetime(offset_aware) == "2026-03-29T18:15:30+08:00"
...
def test_build_imported_reference_metadata_overrides_old_markers_without_mutating_input() -> None:
    original = {
        "import_mode": "full_copy",
        "reference_only_imported_at": "2020-01-01T00:00:00+00:00",
        "remote_reference": {"bucket": "memo", "object_key": "voice.m4a"},
    }
    ...
    assert imported["import_mode"] == "reference_only"
    assert imported["reference_only_imported_at"] != "2020-01-01T00:00:00+00:00"
    assert original["import_mode"] == "full_copy"
    assert original["reference_only_imported_at"] == "2020-01-01T00:00:00+00:00"
